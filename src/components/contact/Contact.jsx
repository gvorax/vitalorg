      ...
      <div className="contact_info">
        <div className="info_day" data-aos="zoom-out" data-aos-delay="400">
          <div className="building">
            ...
            <a href="https://instagram.com/vital.uzb" className="social-links">
              <div className="building_info">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
            ...
            <a href="https://t.me/Vitaluzbekistan" className="social-links">
            <div className="building_info">
              <img src={Telegram} alt="" />
              <a href="https://t.me/Vitaluzbekistan">VitalUzbekistan</a>
            </div>
            </a>
            <a href="https://www.facebook.com/Vital.uzb/" className="social-links">
            <div className="building_info">
